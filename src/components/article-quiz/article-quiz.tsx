    ...
    <div className="flex flex-col gap-4 items-center">
      ...
      <div
        className={`
          ...
          dark:bg-linear-to-b dark:from-indigo-900 dark:via-purple-900 dark:to-indigo-900
         border-amber-200 rounded-2xl p-4 md:p-6 shadow-md
          `}
      >
        <p className="text-base sm:text-xl font-semibold font-cinzel text-gold tracking-wide text-center">
          {mode === "ai"
